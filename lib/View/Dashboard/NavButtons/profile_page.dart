...
//                       color: Colors.black,
//                       size: 50.0 * (0.8 + 0.2 * math.sin(iconController.value * math.pi)),
//                     ),
//                   ),
//                 ),
//               );
...
import 'package:animated_text_kit/animated_text_kit.dart';
import 'package:glassmorphism/glassmorphism.dart';
import 'package:triyaa_com/Components/ProfilePage/body_section.dart';
import 'package:triyaa_com/Components/ProfilePage/build_header.dart';
import 'dart:math' as math;
...
class _ProfilePageState extends State<ProfilePage>
  ...
  Widget _buildFloatingIcons() {
    return Stack(
      children: List.generate(30, (index) {
        final random = math.Random();
        final leftPosition = random.nextDouble() * MediaQuery
            .of(context)
            .size
            .width;
        final topPosition = random.nextDouble() * MediaQuery
            .of(context)
            .size
            .height;
